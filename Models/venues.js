...
class Venue extends Db{
    ...
    constructor()
    {
        ...
        this.schema = this.mongoose.Schema({venueName: String, created_at: Date, updated_at: Date});
    ...
    create(venueName)
    {
        ...
        this.collectionName.insert({venueName: venueName, created_at: created_at, updated_at: updated_at}, (err)=>{
